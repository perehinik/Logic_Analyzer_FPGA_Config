...
#
# Generated by Vivado on Wed Sep 02 19:05:55 +0200 2020
...
# Script info
echo -e "clk_wiz_1.sh - Script generated by export_simulation (Vivado v2018.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../LogAn_v2.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1_clk_wiz.v" \
    "$ref_dir/../../../../LogAn_v2.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1.v" \
  2>&1 | tee -a vlogan.log
