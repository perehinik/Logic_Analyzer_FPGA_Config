...
#
# Generated by export_simulation on Sun Oct 11 13:57:41 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './fifo_generator_1.sh' script.

./fifo_generator_1.sh -reset_run
...
./fifo_generator_1.sh -noclean_files

For more information on the script, please type './fifo_generator_1.sh -help'.
